...
> **⚠️ SPECIFICATION DOCUMENT**: This describes the complete vision for DavisTensor.  
> See [davistensor/spec/ROADMAP.md](davistensor/spec/ROADMAP.md) for current implementation status.
